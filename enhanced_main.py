...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python enhanced_main.py puzzle.png
  python enhanced_main.py puzzle.txt --llm-provider anthropic --live-dashboard
  python enhanced_main.py --interactive --puzzles-dir ./puzzles
  python enhanced_main.py puzzle.zip --max-workers 5 --timeout 60
        """
    )
    ...
    interface_group.add_argument("--live-dashboard", action="store_true",
                                help="Show live analysis dashboard")
    interface_group.add_argument("--dashboard-refresh", type=float, default=2.0,
